    ...
    public class Grabbable : MonoBehaviour
    {
        ...
        protected virtual void HandAttachedUpdate(Hand hand)
        {
            ...
            if (onHeldUpdate != null)
                ...
                GrabTypes bestGrabType = hand.otherHand.GetBestGrabbingType();
                ...
                if (bestGrabType != GrabTypes.None)
                {
                    if (!scaling)
                    {
                        ...
                        scaling = true;
                        ogDist = (hand.otherHand.transform.position - hand.transform.position).magnitude;
                    }

                    float dist = (hand.transform.position - hand.otherHand.transform.position).magnitude - ogDist;
                    
                    transform.localScale = ogScale + 4f*new Vector3(dist, dist, dist);
                    // transform.position = hand.transform.position + hand.otherHand.transform.position / 2f;
                }
                else
                {
                    scaling = false;
